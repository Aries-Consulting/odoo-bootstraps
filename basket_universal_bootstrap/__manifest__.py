# -*- coding: utf-8 -*-
{
    ...
    'version': '18.0.1.0.0',
    'category': 'Technical',
    'summary': 'Installs all Universal basket modules (8 modules)',
    'description': """
        Bootstrap module for any Odoo 18 project (any country).

        Installing this single module will install all 8 Universal modules:
        ...
        **Usage:**
        ...
        the 8 modules will remain installed and can be managed individually.

        **For Argentine projects:** Use basket_ar_bootstrap instead (includes these 8 + 20 AR modules).
    """,
